  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4">
      ...
      {conversation.length > 0 && (
        <div ref={shareRef} className="w-full max-w-xl mb-4 p-4 bg-black rounded-lg">
      ...
      {conversation.length > 0 && (
        <div className="flex gap-3 mt-4 items-center justify-center z-50">
          <button
            onClick={() => {
          ...
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              console.log('Camera button click detected!');
              handleCapture();
            }}
            className="bg-zinc-700 text-blue-200 p-3 rounded-md border border-blue-400 hover:bg-zinc-800 transition cursor-pointer z-50"
          ...
          <button
            ...
            className="bg-red-600 text-white px-3 py-2 rounded text-sm cursor-pointer z-50"
            type="button"
            style={{ 
              pointerEvents: 'auto',
              position: 'relative',
